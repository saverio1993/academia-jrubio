...
export function LiveViewer() {
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-4">
      ...
      {/* ── Columna izquierda: badge + player + atajos ── */}
      ...
      {/* ── Columna derecha: chat (sidebar en desktop, debajo en móvil) ── */}
      <div className="xl:w-80 2xl:w-96 shrink-0 flex flex-col">
        <div className="rounded-2xl border overflow-hidden flex flex-col flex-1" style={{ borderColor: 'var(--color-border)', background: 'var(--color-card)' }}>
          ...
          {/* Mensajes — h-64 en móvil, flex-1 en sidebar desktop */}
          <div className="h-64 xl:flex-1 xl:h-auto overflow-y-auto px-4 py-3 space-y-2 flex flex-col">
            {msgs.length === 0 && (
