    ...
    <main className="landing" style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="center-screen">
        <div className="authcard">
          <h1>
            Bienvenido a <span style={{ color: 'var(--lp-accent)' }}>Academia J Rubio</span>
          </h1>
          <p className="muted">Inicia sesión para acceder a tu biblioteca, cursos y soporte premium.</p>
          ...
          <p className="muted" style={{ marginTop: 22, marginBottom: 0, fontSize: 12.5 }}>
