...
export async function registerUser(
  ...
  // Auto-iniciar sesión y redirigir a planes
  await signIn('credentials', { email, password, redirectTo: '/planes' });

  // redirect() ya lo hace signIn — esta línea es por si acaso
  redirect('/planes');
}
